...
8. App logo size adjusts from branding setting page
9. Update onboard steps for remove video and documentation link(Version13)
10. Navbar Background color manage from branding setting.
11. Custom Navbar Title and CSS for title Manage from branding setting.
12. Change Login Page Title From branding Setting Page

branding Setting Page
...
Below are important setting in branding setting page.
1. Ignore Onboard branding:<br/>
   If this setting value true then this app will not branding onboarding steps and onboarding modules.
2. Show help menu:<br/>
...
1. bench get-app https://github.com/MDALAMIN2526/branding.git<br/>
2. bench --site sitename install-app branding<br/>
3. bench migrate<br/>
4. bench restart<br/>
5. bench clear-cache
